...
- [x] **Supabase-Migration ausgeführt (16.09.2026)** — `supabase/migration-2026-08-06-lock-admin-column.sql` im SQL-Editor eingespielt und von außen geprüft: `admin_set_is_admin` existiert, anonyme Aufrufe und PATCH auf `is_admin` werden mit 42501 abgewiesen. Vorher existierten die Admin-Funktionen nicht, „Promote to admin" und „Delete user" schlugen fehl.
